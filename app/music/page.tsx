    ...
    <PlayerProvider>
      ...
      <main className="min-h-screen text-white relative bg-transparent overflow-hidden" style={{zIndex:10}}>
        ...
        <section className="py-16 px-4 flex flex-col items-center justify-center relative overflow-hidden" style={{minHeight:380}}>
          <div className="w-full max-w-4xl bg-black/40 backdrop-blur-lg rounded-xl shadow-2xl shadow-black/40 border border-white/10 flex flex-col md:flex-row overflow-hidden relative z-10">
            <PlayerUI 
              tracks={tracks} 
        ...
        <section className="py-16 px-4 flex flex-col items-center justify-center border-t border-neutral-800">
          <div className="flex justify-center mb-12 relative z-10">
            <span className="inline-block px-6 py-2 border border-white text-xl uppercase tracking-wider text-white font-normal bg-black/60 rounded">Last Release</span>
          </div>
          <div className="w-full max-w-3xl aspect-video rounded-lg overflow-hidden border-2 border-indigo-700 shadow-lg mx-auto bg-black/40 backdrop-blur-lg border border-white/10 shadow-2xl shadow-black/40">
            <iframe
              width="100%"
              height="100%"
        ...
        {/* Next Drops Section (tabla) */}
        <section className="py-16 px-4 flex flex-col items-center justify-center border-t border-neutral-800">
          <div className="w-full max-w-3xl mx-auto">
            <div className="flex justify-center mb-12 relative z-10">
              <span className="inline-block px-6 py-2 border border-white text-xl uppercase tracking-wider text-white font-normal bg-black/60 rounded">Next Drops</span>
            </div>
        ...
        <section className="py-16 px-4 flex flex-col items-center justify-center border-t border-neutral-800">
          <div className="flex justify-center mb-12 relative z-10">
            <span className="inline-block px-6 py-2 border border-white text-xl uppercase tracking-wider text-white font-normal bg-black/60 rounded">Top Collectors</span>
          </div>
          {/* Mobile: tarjetas apiladas */}
          <div className="block md:hidden w-full px-2 space-y-4">
            {collectors.map((collector, idx) => (
              <div
                key={idx}
                className="flex items-center bg-black/80 rounded-2xl shadow-lg border border-neutral-800 w-full px-3 py-4 gap-4"
              >
                {/* Avatar */}
        ...
        {modalCollectible && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
            <div className="bg-black rounded-3xl shadow-2xl max-w-3xl w-full flex flex-col md:flex-row overflow-hidden relative border-none mx-2 my-4 md:mx-2 md:my-4 h-full md:h-auto
              sm:ml-0 ml-[64px] sm:w-full w-[calc(100vw-64px)]">
              {/* Close button */}
              <button onClick={() => setModalCollectible(null)} className="absolute top-2 right-2 md:top-4 md:right-4 text-white text-3xl font-bold hover:text-red-400 transition-colors bg-black/60 rounded-full w-10 h-10 md:w-12 md:h-12 flex items-center justify-center z-10 border-2 border-white/10">
                ×
              </button>
              {/* Image */}
              <div className="flex items-center justify-center p-4 md:p-12 bg-black w-full md:w-[380px]">
                <img src={modalCollectible.cover} alt={modalCollectible.title} className="max-h-60 md:max-h-96 w-auto rounded-2xl shadow-xl border-2 border-white/10" />
              </div>
              {/* Info */}
              <div className="flex flex-col justify-center px-4 py-4 md:px-8 md:py-8 gap-4 md:gap-6 w-full overflow-y-auto max-h-[80vh] md:max-h-none">
                <div>
